...
public class MenuAdmin {
    ...
    public void menuAdmin(ManagerCustomer managerCustomer, ManagerBills managerBills, ManagerProducts managerProducts, ReadAndWrite readAndWrite) {
        while (true) {
