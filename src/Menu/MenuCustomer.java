...
public class MenuCustomer {
    ...
    public void menuCustomer(Customer customer, ManagerProducts managerProducts, ManagerBills managerBills, ReadAndWrite readAndWrite) {
        while (true) {
            ...
            switch (choice) {
                case 1:
                    customer.muaHang(managerProducts, managerBills, readAndWrite);
                    break;
                case 2:
