            ...
            switch (choice) {
                case 1:
                    ...
                    if (account instanceof Admin) {
                        ...
                        menuAdmin.menuAdmin(managerCustomer, managerBills, managerProducts, readAndWrite);

                    }
                    if (account instanceof Customer) {
                        Customer customer = (Customer) account;

                        menuCustomer.menuCustomer(customer, managerProducts, managerBills, readAndWrite);
                    ...
                    break;
                case 2:
                    managerCustomer.dangky(managerAccount);
                    readAndWrite.write(managerAccount.accounts, "Accounts.txt");
                    break;
                case 3:
                    System.exit(0);
